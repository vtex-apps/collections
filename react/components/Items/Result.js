      ...
      <div>
        <div className="flex items-center">
          ...
          <div className="bt bl bb br b--light-gray pa4 flex items-center f6 flex-grow-1 justify-between relative bg-near-white">
            ...
            <button className="bg-serious-black pa2 br-100 absolute flex items-center bn pointer dim" style={{ right: '-0.75rem' }}>
              <IconArrowUp
                fill="#FFFFFF"
                width={14}
                height={14}
        ...
        <div className="flex items-center">
          ...
          <div className="bt bl br b--light-gray pa4 flex items-center f6 flex-grow-1 justify-between relative">
            <div className="flex items-center">
              <img src="http://lojavans.vteximg.com.br/arquivos/ids/169798-1000-1000/VN0A36ISQHZ_01.jpg?v=636465356869730000" style={{ width: '3rem', height: '3rem' }} />
        ...
        <div className="flex items-center">
          ...
          <div className="bt bl bb br b--light-gray pa4 flex items-center f6 flex-grow-1 justify-between relative">
            <div className="flex items-center">
              <img src="http://lojavans.vteximg.com.br/arquivos/ids/167527-1000-1000/VN0A2X3B600_001.jpg?v=636440299842170000" style={{ width: '3rem', height: '3rem' }} />
